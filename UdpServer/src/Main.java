...
public class Main {
    public static void main(String[] args) {
        ...
        PortUtil portUtil = new PortUtil("UDP Server");
        ...
        if (portUtil.isAvailablePort(localPort)) {
            try{
                ...
                UDPServer udpServer = new UDPServer(applicationName, localPort, storagePort);
                Thread serverThread = new Thread(udpServer::start);
                serverThread.start();
                ...
                while (true) {
                    ...
                    if ("exit".equalsIgnoreCase(command)) {
                        portUtil.deletePortStatus("UDP", localPort);
